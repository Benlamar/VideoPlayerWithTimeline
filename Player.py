...
class Player(QMainWindow):
    def __init__(self):
        ...
        self.timeline.signal.jump.connect(self.seekPosition)
    ...
    def setupMenu(self):
        ...
        open_action = QAction(
            icon, "&Open...", self, shortcut=QKeySequence.Open, triggered=self.open
        )
    ...
    def open(self):
        ...
        file_list, _ = QFileDialog.getOpenFileUrls(
            self, caption="Select video files", dir=home_url, filter=file_filter
        )
